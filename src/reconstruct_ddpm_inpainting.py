...
def reconstruct_ddpm_inpainting(distance_matrices_correct, CM, device="cuda:0", n_generation_steps = 550):
...
def reconstruct_ddpm_inpainting_batched(distance_matrices_correct, CM, device="cuda:0",     n_generation_steps = 550):
